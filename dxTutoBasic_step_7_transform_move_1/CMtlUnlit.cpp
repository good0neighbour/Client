...
void CMtlUnlit::Create(ID3D11Device* tpDevice)
{
	CreateShader(tpDevice);
}
void CMtlUnlit::Destroy()
{
	DestroyShader();
}
void CMtlUnlit::Render(int tCountIndex, ID3D11ShaderResourceView* tpTexture)
{
...
void CMtlUnlit::CreateShader(ID3D11Device* tpDevice)
{
    ID3DBlob* pVSBlob = nullptr;

    CompileShaderFromFile(L"unlit_vs.hlsl", "main", "vs_4_0", &pVSBlob);
    ...
    CompileShaderFromFile(L"unlit_ps.hlsl", "main", "ps_4_0", &pPSBlob);
...
void CMtlUnlit::RenderShader(ID3D11DeviceContext* tpDeviceContext, int tCountIndex)
{    
...
void CMtlUnlit::SetShaderParameter(ID3D11DeviceContext* tpDeviceContext, ID3D11ShaderResourceView* tpTexture)
{
    tpDeviceContext->PSSetShaderResources(0, 1, &tpTexture);
}


HRESULT CMtlUnlit::CompileShaderFromFile(const WCHAR* szFileName, LPCSTR szEntryPoint, LPCSTR szShaderModel, ID3DBlob** ppBlobOut)
{
    HRESULT hr = S_OK;
