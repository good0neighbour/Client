...
/*
    ...
    i)CMtlTexture
            <--Material재질 개념을 다루는 클래스

            shading: 최종색상결정  = (물체의 색상, 텍스처, 조명)
            shader: shading을 하는 작은 조각 프로그램
            Material: How to Shading 
                    어떻게 셰이딩(최종색상결정)을 해야 하는지에 대한 데이터와 방법을 다루는 개념
                    ( 즉, 그 정체는 셰이더를 다루는 것을 추상화해놓은 것이다 )
...
public:
    ...
    virtual void OnUpdate(float tDeltaTime) override
    {
        ...
        XMFLOAT4 tLightColor = XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f);//rgba
