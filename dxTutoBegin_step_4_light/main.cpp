...
public:
    virtual void OnCreate() override
    {
        ...
        */
        ...
        tBd.ByteWidth = sizeof(SVertex) * 24;    //해당 기하구조의 메모리 크기를 알린다
